...
import logoDark from "@/assets/reconpro-logo-dark.png";
import logoLight from "@/assets/reconpro-logo-light.png";
...
const iconPaths: Record<string, React.ReactNode> = {
  ...
  flame: <><path d="M8.5 14.5A2.5 2.5 0 0011 12c0-1.38-.5-2-1-3 1.5 2 2.5 3.5 2.5 5a3.5 3.5 0 01-7 0c0-2.5 2-4.5 3-6.5 1 2 2 3 2 5a1.5 1.5 0 01-2 1.5"/><path d="M12 2c1 2.5 3 5.5 3 8.5a7 7 0 01-14 0C1 7.5 5 4 7 2c0 3 1.5 5 3 7 1-2 2-4 2-7z" fill="none"/></>,
...
export const Logo = ({ size = 80, width, height }: { size?: number; width?: number; height?: number }) => {
  ...
  return (
    <img
      src={logoSrc}
      alt="ReCon Pro"
      style={{ maxHeight: height ?? size, width: width ?? "auto", objectFit: "contain", display: "block" }}
    />
  );
};
