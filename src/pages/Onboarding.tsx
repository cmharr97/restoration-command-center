...
async function seedDemoData(companyId: string, userId: string) {
  const demoJobs = [
    ...
    { id: `DEMO-004`, customer: "Williams Home", address: "3344 Sunset Ridge, Pflugerville TX 78660", phone: "(512) 555-0504", loss_type: "mold", loss_subtype: "Type 2 (med)", stage: "mitigation", carrier: "USAA", claim_no: "US-2026-55820", adjuster: "David Brown", date_of_loss: "2026-03-03", pm_name: "Chris Martinez", priority: "normal", notes: "Mold discovered behind master bathroom shower wall. Spread to adjacent closet. Full containment required.", contract_value: 18000, mitigation_value: 18000, company_id: companyId, created_by: userId },
    ...
    { id: `DEMO-006`, customer: "Patel Residence", address: "6700 Barton Springs Rd, Austin TX 78704", phone: "(512) 555-0706", loss_type: "water", loss_subtype: "Cat 3 – Black", stage: "carrier_approval", carrier: "State Farm", claim_no: "SF-2026-91203", adjuster: "Lisa Chen", date_of_loss: "2026-02-25", pm_name: "Chris Martinez", priority: "high", notes: "Sewage backup from main line. Full demo of affected areas including laundry room and garage.", contract_value: 34200, mitigation_value: 11500, company_id: companyId, created_by: userId },
    { id: `DEMO-007`, customer: "Riverside Apartments Unit 4B", address: "2100 Riverside Dr #4B, Austin TX 78741", phone: "(512) 555-0807", loss_type: "water", loss_subtype: "Cat 1 – Clean", stage: "closed", carrier: "Liberty Mutual", claim_no: "LM-2026-28401", adjuster: "Tom Garcia", date_of_loss: "2026-01-15", pm_name: "Jake Reynolds", priority: "normal", notes: "AC condensate line overflow. Minor drywall and carpet damage. Completed in 5 days.", contract_value: 6800, mitigation_value: 6800, company_id: companyId, created_by: userId },
  ];
